...
In this study, we wish to use machine learning-based classification models to study cancer occurrence in the US population. We are still finalizing the feature/independent variables.
